...
# I cannot find a source for these!
# It is very important that these are aligned with the finetuning step.
COCO_LABELS = [
    ...
    'kite', 'baseball bat', 'bottle', 'skateboard', 'cup', 'tennis racket',
